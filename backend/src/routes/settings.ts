...
router.get('/settings/profile', requireSession, async (req: any, res) => {
  try {
...
router.put('/settings/profile', requireSession, async (req: any, res) => {
  try {
...
router.put('/settings/password', requireSession, async (req: any, res) => {
  try {
...
router.get('/settings/download', requireSession, async (req: any, res) => {
...
router.put('/settings/download', requireSession, async (req: any, res) => {
  try {
    const body = z
...
router.post('/settings/download/verify', requireSession, async (req: any, res) => {
  try {
...
router.delete('/settings/account', requireSession, async (req: any, res) => {
  try {
