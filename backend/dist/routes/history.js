...
router.get('/history/:id', requireSession, async (req, res) => {
...
router.post('/history', requireSession, async (req, res) => {
    try {
...
router.delete('/history/:id', requireSession, async (req, res) => {
