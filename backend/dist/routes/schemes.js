...
router.post('/schemes/save', requireSession, async (req, res) => {
    try {
...
router.get('/schemes/:id', requireSession, async (req, res) => {
...
router.get('/schemes', requireSession, async (req, res) => {
    try {
...
router.delete('/schemes/:id', requireSession, async (req, res) => {
